...
#define GPU_LEVEL                                                              \
  5 // percentage of GPU memory to be used for compression/decompression
...
template <typename T> cudaError_t cudaMallocTracked(T **pointer, size_t size) {
...
__device__ int get_tid() { return blockIdx.x * blockDim.x + threadIdx.x; }
...
__device__ int Ilog::operator()(U16 x) const { return table[x]; }
__device__ int Ilog::operator()(U32 x) const {
  if (x >= 0x1000000)
    return 256 + table[x >> 16]; //  return 256+ ilog->operator()(x >> 16);
  else if (x >= 0x10000)
    return 128 + table[x >> 8]; // return 128+ ilog->operator()(x >> 8);
  else
...
__device__ static const U8 State_table[256][2] = {
    {1, 2},     {3, 5},     {4, 6},     {7, 10},    {8, 12},    {9, 13},
    {11, 14},   {15, 19},   {16, 23},   {17, 24},   {18, 25},   {20, 27},
    {21, 28},   {22, 29},   {26, 30},   {31, 33},   {32, 35},   {32, 35},
    {32, 35},   {32, 35},   {34, 37},   {34, 37},   {34, 37},   {34, 37},
    {34, 37},   {34, 37},   {36, 39},   {36, 39},   {36, 39},   {36, 39},
    {38, 40},   {41, 43},   {42, 45},   {42, 45},   {44, 47},   {44, 47},
    {46, 49},   {46, 49},   {48, 51},   {48, 51},   {50, 52},   {53, 43},
    {54, 57},   {54, 57},   {56, 59},   {56, 59},   {58, 61},   {58, 61},
    {60, 63},   {60, 63},   {62, 65},   {62, 65},   {50, 66},   {67, 55},
    {68, 57},   {68, 57},   {70, 73},   {70, 73},   {72, 75},   {72, 75},
    {74, 77},   {74, 77},   {76, 79},   {76, 79},   {62, 81},   {62, 81},
    {64, 82},   {83, 69},   {84, 71},   {84, 71},   {86, 73},   {86, 73},
    {44, 59},   {44, 59},   {58, 61},   {58, 61},   {60, 49},   {60, 49},
    {76, 89},   {76, 89},   {78, 91},   {78, 91},   {80, 92},   {93, 69},
    {94, 87},   {94, 87},   {96, 45},   {96, 45},   {48, 99},   {48, 99},
    {88, 101},  {88, 101},  {80, 102},  {103, 69},  {104, 87},  {104, 87},
    {106, 57},  {106, 57},  {62, 109},  {62, 109},  {88, 111},  {88, 111},
    {80, 112},  {113, 85},  {114, 87},  {114, 87},  {116, 57},  {116, 57},
    {62, 119},  {62, 119},  {88, 121},  {88, 121},  {90, 122},  {123, 85},
    {124, 97},  {124, 97},  {126, 57},  {126, 57},  {62, 129},  {62, 129},
    {98, 131},  {98, 131},  {90, 132},  {133, 85},  {134, 97},  {134, 97},
    {136, 57},  {136, 57},  {62, 139},  {62, 139},  {98, 141},  {98, 141},
    {90, 142},  {143, 95},  {144, 97},  {144, 97},  {68, 57},   {68, 57},
    {62, 81},   {62, 81},   {98, 147},  {98, 147},  {100, 148}, {149, 95},
    {150, 107}, {150, 107}, {108, 151}, {108, 151}, {100, 152}, {153, 95},
    {154, 107}, {108, 155}, {100, 156}, {157, 95},  {158, 107}, {108, 159},
    {100, 160}, {161, 105}, {162, 107}, {108, 163}, {110, 164}, {165, 105},
    {166, 117}, {118, 167}, {110, 168}, {169, 105}, {170, 117}, {118, 171},
    {110, 172}, {173, 105}, {174, 117}, {118, 175}, {110, 176}, {177, 105},
    {178, 117}, {118, 179}, {110, 180}, {181, 115}, {182, 117}, {118, 183},
    {120, 184}, {185, 115}, {186, 127}, {128, 187}, {120, 188}, {189, 115},
    {190, 127}, {128, 191}, {120, 192}, {193, 115}, {194, 127}, {128, 195},
    {120, 196}, {197, 115}, {198, 127}, {128, 199}, {120, 200}, {201, 115},
    {202, 127}, {128, 203}, {120, 204}, {205, 115}, {206, 127}, {128, 207},
    {120, 208}, {209, 125}, {210, 127}, {128, 211}, {130, 212}, {213, 125},
    {214, 137}, {138, 215}, {130, 216}, {217, 125}, {218, 137}, {138, 219},
    {130, 220}, {221, 125}, {222, 137}, {138, 223}, {130, 224}, {225, 125},
    {226, 137}, {138, 227}, {130, 228}, {229, 125}, {230, 137}, {138, 231},
    {130, 232}, {233, 125}, {234, 137}, {138, 235}, {130, 236}, {237, 125},
    {238, 137}, {138, 239}, {130, 240}, {241, 125}, {242, 137}, {138, 243},
    {130, 244}, {245, 135}, {246, 137}, {138, 247}, {140, 248}, {249, 135},
    {250, 69},  {80, 251},  {140, 252}, {249, 135}, {250, 69},  {80, 251},
    {140, 252}, {0, 0},     {0, 0},     {0, 0}};
...
protected:
  ...
  U32 *prediction_table; // cntxt -> prediction in high 22 bits, count in low 10
                         // bits
...
__device__ StateMap::StateMap(U32 *prediction_table_ptr, int n)
    : prediction_table(prediction_table_ptr), N(n), cntxt(0) {
...
__device__ void StateMap::update(int y, int limit) {
  ...
  int n = prediction_table[cntxt] & 1023,
      p = prediction_table[cntxt] >> 10; // count, prediction
  ...
  prediction_table[cntxt] +=
      (((y << 22) - p) >> 3) * state_map_dt[n] & 0xfffffc00;
}
...
__device__ Mix::Mix(int *weight_ptr, int n)
    : wt(weight_ptr), N(n), x1(0), x2(0), context(0), last_prediction(0) {
...
__device__ int Mix::prediction(int p1, int p2, int cntxt) {
  assert(cntxt >= 0 & cntxt < N);
  context = cntxt * 2;
  return last_prediction = ((x1 = p1) * (wt[context] >> 16) +
                            (x2 = p2) * (wt[context + 1] >> 16) + 128) >>
                           8;
}
...
template <int B> class HashTable {
  U8 *table;     // table: 1 element= B bytes: checksuj priority data
  U8 *raw_table; // true address returned by alloc(), before cache-line
                 // alignment
...
template <int B>
__device__ HashTable<B>::HashTable(int n, U8 *table_ptr)
    : table(table_ptr), raw_table(0), N(n) {
  assert(B >= 2 && (B & B - 1) == 0);
  assert(N >= B * 4 && (N & N - 1) == 0);
  // allocator[get_tid()]->alloc(table, N + B * 4 + 64);
  raw_table = table; // remember true allocation address
  table += 64 - int(reinterpret_cast<uintptr_t>(table) &
                    63); // align on cache line boundary
}

template <int B> __device__ U8 *HashTable<B>::operator[](U32 i) {
  i *= 123456791;
  i = i << 16 | i >> 16;
  i *= 234567891;
  int chk = i >> 24;
...
template <int B> __device__ HashTable<B>::~HashTable() {
...
__device__ size_t MEM =
    1 << (19 + 1); // Global memory limit, 1 << 19+(memory option)
...
public:
  ...
  __device__ LZP(StateMap *statemap1, U8 *buffer, U32 *table, APM *apm1,
                 APM *apm2, APM *apm3);
  __device__ ~LZP();
  ...
  __device__ int
  probability(); // probability that next char is predict_char()*4096
  __device__ void update(int ch); // update model with actual char ch
};
// Initilization

__device__ LZP::LZP(StateMap *statemap, U8 *buf, U32 *tab, APM *apm1, APM *apm2,
                    APM *apm3)
    : N(MEM / 8), H(MEM / 32), match(-1), len(0), pos(0), hash(0), hash1(0),
      hash2(0), statemap(statemap), apm1(apm1), apm2(apm2), apm3(apm3),
...
__device__ int LZP::probability() {
  ...
  pr = apm2->prediction(2048, pr * 2, hash1 * (11 << 6) + pc & 0x3ffff) * 3 +
           pr >>
       2;
  pr = apm3->prediction(2048, pr * 2, hash1 * (7 << 4) + pc & 0xfffff) * 3 +
           pr >>
       2;
...
__device__ void LZP::update(int ch) {
  ...
  if (y) { // extend match
    ...
    if (!((match ^ pos) & N - 1))
      --match;
    while (len <= 128 &&
           buffer[match - len & N - 1] == buffer[pos - len & N - 1])
      ++len;
    --len;
  }
  table[hash] = pos;
...
public:
  __device__ Predictor(U8 *context1_ptr, StateMap *statemap1[N],
                       Mix *mix1[N - 1], APM *apm1, APM *apm2, APM *apm3,
                       HashTable<16> *hashtable_ptr);
  __device__ ~Predictor(); // frees context1; member destructors free
                           // hashtable/statemap/mix/apm
  __device__ int predict_next_bit();
  __device__ void update(int y);
};

// Initialize
__device__ Predictor::Predictor(U8 *context1_ptr, StateMap *statemap1[N],
                                Mix *mix1[N - 1], APM *apm1, APM *apm2,
                                APM *apm3, HashTable<16> *hashtable_ptr)
    : c0(0), context1(context1_ptr), nibble(1), bcount(0), apm1(apm1),
      apm2(apm2), apm3(apm3), hashtable(hashtable_ptr) {
...
__device__ int Predictor::predict_next_bit() {
  ...
  if (c0 == 0)
    ...
    int r =
        pc + 256 >> 8 - bcount == c0; // c0 consistent with mispredicted byte?
    U32 c4 =
        lzp[tid]->context4(); // last 4 whole context bytes, shifted into LSB
    U32 c8 = (lzp[tid]->context8() << 4) -
             1;              // hash of last 7 bytes with 4 trailing 1 bits
    if ((bcount & 3) == 0) { // nibble boundary?  Update context pointers
      ...
      cp[10] = hashtable->operator[](
          (lzp[tid]->word1 * 7 + lzp[tid]->word0 * 11 + c0 + pc * 37));
    }
    ...
    for (int i = 1; i < N; ++i) {
      ...
      int st = *sp[i];
      pr = mix[i - 1]->prediction(
               pr, stretch->operator()(statemap[i]->predict_next_bit(st)),
               st + r) *
                   3 +
               pr >>
           2;
    }
    pr = apm1->prediction(512, pr * 2, c0 + pc * 256 & 0xffff) * 3 + pr >>
         2; // Adjust prediction
...
public:
  ...
  __device__ Encoder(int m, char *temp, unsigned char *buffer_ptr, size_t tsz,
                     size_t itr);
  __device__ ~Encoder(); // frees buf (COMPRESS mode only; inout is not owned by
                         // Encoder)
...
__device__ Encoder::Encoder(int m, char *temp, unsigned char *buffer_ptr,
                            size_t tsz, size_t itr)
    : mode(m), inout(temp), buffer(buffer_ptr), total_size(tsz),
      iterator_size(itr), x1(0), x2(0xffffffff), x(0), usize(0), csize(0),
      usum(0), csum(0) {
  int tid = get_tid();
...
__device__ Encoder::~Encoder() {
  ...
  buffer = 0;
  // inout is owned by the caller (points into the chunk's device buffer) -
  // never freed here.
}
...
__global__ void paq9_cuda(size_t *input_size, char **input, size_t *output_size,
                          char **output, unsigned char **buffer,
...
__global__ void init(int thread_count, ThreadBuffers *buffers,
                     int memory_level) {
  int tid = get_tid();
  if (tid < thread_count) {
    ...
    lzp[tid] = new LZP(lzp_statemap, buffer.lzp_buffer, buffer.lzp_table,
                       lzp_apm1, lzp_apm2, lzp_apm3);
    ...
    HashTable<16> *predictor_hashtable =
        new HashTable<16>(MEM / 2, buffer.predictor_hashtable);
    predictor[tid] = new Predictor(
        buffer.predictor_context1, predictor_statemap, predictor_mix,
        predictor_apm1, predictor_apm2, predictor_apm3, predictor_hashtable);
...
size_t calculateThreadBufferBytes(int memory_level) {
  ...
  total +=
      (MEM_host / 32) * sizeof(U32); // lzp_table    (memory_level dependent)
  ...
  total += (MEM_host / 2 + 128) *
           sizeof(U8);           // predictor_hashtable (memory_level dependent)
...
void memoryAllocationForThread(int thread_count) {
  ...
  U32 MEM_host =
      1U << (19 + memory_level); // compute on host, don't rely on device write
  ...
  for (int i = 0; i < thread_count; i++) {
    ...
    cudaMallocTracked(&encoder_buffer[i],
                      0x20000 * sizeof(unsigned char)); // encoder buffer
  }
}
...
void compress(char *destination_file, char *source_file) {
  ...
  if (err1 != cudaSuccess) {
    std::cerr << "Launch error heap: " << cudaGetErrorString(err1) << '\n';
    exit(1);
  }

  err1 = cudaDeviceSynchronize();
  if (err1 != cudaSuccess) {
    std::cerr << "Kernel error heap: " << cudaGetErrorString(err1) << '\n';
    exit(1);
  }
  ...
  size_t memory_per_thread =
      2 * chunk_MB * MB + calculateThreadBufferBytes(memory_level) + 1 * MB;

  int maximum_thread_per_device_call =
      (maximum_memory + memory_per_thread - 1) / memory_per_thread;

  size_t chunk_B = chunk_MB * MB;

  // std::cout << chunk_MB << " " << memory_level << " " << memory_per_thread <<
  // " " << maximum_thread_per_device_call << " " << chunk_B << endl;

  int num_of_chunks = (total_B + chunk_B - 1) / chunk_B;

  int device_call_count = (num_of_chunks + maximum_thread_per_device_call - 1) /
                          maximum_thread_per_device_call;
  ...
  // put4_stream(maximum_thread_per_device_call, dest); // maximum thread per
  // device call
  ...
  std::cout << "Maximum Thread at a time: " << maximum_thread_per_device_call
            << endl;
  // std::cout << "Maximum processed per device call: "
  //           << maximum_thread_per_device_call * chunk_B / MB << " MB" <<
  //           endl;
  ...
  std::cout << "Memory Allocation Time: " << elapsed_time1.count() << " seconds"
            << endl;
  cudaError_t err = cudaGetLastError();
  if (err != cudaSuccess) {
    std::cerr << "Launch Kernel error: " << cudaGetErrorString(err) << '\n';
    exit(1);
  }

  err = cudaDeviceSynchronize();
  if (err != cudaSuccess) {
    std::cerr << "Initialization kernel error: " << cudaGetErrorString(err)
              << '\n';
    exit(1);
  }
  ...
  cudaMallocTracked(&d_input_size, num_of_thread * sizeof(size_t));
  ...
  // --------------------------------------------------
  char **temp_d_input = new char *[num_of_thread];

  char **temp_d_output = new char *[num_of_thread];
  // --------------------------------------------------
  // Allocate each chunk on DEVICE
  // --------------------------------------------------
  for (int i = 0; i < num_of_thread; i++) {
    // Input
    cudaMallocTracked(&temp_d_input[i], chunk_B * sizeof(char));

    // Output
    //
    // Currently output size == input size
    // because your kernel only copies data.
    cudaMallocTracked(&temp_d_output[i], (chunk_B + 2) * sizeof(char));
  }
  ...
  for (int call_count = 0; call_count < device_call_count; call_count++) {
    ...
    int num_of_current_thread =
        std::min(maximum_thread_per_device_call,
                 (num_of_chunks - call_count * maximum_thread_per_device_call));
    ...
    for (size_t i = 0; i < num_of_current_thread; i++) {
      size_t current_B =
          min(chunk_B,
              total_B - ((call_count * maximum_thread_per_device_call) + i) *
                            chunk_B);
    ...
    cudaMemcpy(d_input_size, input_size.data(),
               num_of_current_thread * sizeof(size_t), cudaMemcpyHostToDevice);
    ...
    for (int i = 0; i < num_of_current_thread; i++) {
      ...
      cudaMemcpy(temp_d_input[i], src_file[i], input_size[i] * sizeof(char),
    ...
    cudaMemcpy(d_input, temp_d_input, num_of_current_thread * sizeof(char *),
               cudaMemcpyHostToDevice);

    cudaMemcpy(d_output, temp_d_output, num_of_current_thread * sizeof(char *),
               cudaMemcpyHostToDevice);

    cudaMemcpy(d_encoder_buffer, encoder_buffer,
    ...
    int blocks = (num_of_current_thread + threads - 1) / threads;
    ...
    std::cout << "Device initialization time: " << init_duration.count()
              << " ms" << endl;
    cudaError_t err1;
    err1 = cudaGetLastError();
    if (err1 != cudaSuccess) {
    ...
    std::cout << "input size: " << input_size[0]
              << " Byte, Current threads: " << num_of_current_thread << endl;
    paq9_cuda<<<blocks, threads>>>(
        d_input_size, d_input, d_output_size, d_output, d_encoder_buffer,
    ...
    std::cout << "Kernel execution time: " << kernel_duration.count() << " ms"
              << endl;
    err1 = cudaGetLastError();
    if (err1 != cudaSuccess) {
      std::cerr << "Launch error paq9: " << cudaGetErrorString(err1) << '\n';
      exit(1);
    }

    err1 = cudaDeviceSynchronize();
    if (err1 != cudaSuccess) {
      std::cerr << "Kernel error paq9: " << cudaGetErrorString(err1) << '\n';
      exit(1);
    }
    ...
    cudaMemcpy(output_size, d_output_size,
               num_of_current_thread * sizeof(size_t), cudaMemcpyDeviceToHost);
    ...
    for (int i = 0; i < num_of_current_thread; i++) {
      ...
      cudaMemcpy(output[i], temp_d_output[i], output_size[i] * sizeof(char),
    ...
    for (size_t i = 0; i < num_of_current_thread; i++) {
      ...
      // std::cout << input_size[i] << " Byte -> " << output_size[i] << " Byte"
      // << endl;
    }

    // std::cout << "\n\nPer Device Call:" << total_input << " Byte->" <<
    // total_output << " Byte " << endl;
  ...
  std::cout << "Total: " << total_uncompressed_size << " Byte -> "
            << total_compressed_size << " Byte" << endl;

  std::cout << "Compression Ratio: "
            << 1.0 * total_uncompressed_size / total_compressed_size << endl;
}
...
void decompress(const char *destination_file, const char *source_file) {
  ...
  if (mode == 's') {
    ...
    int maximum_thread_per_device_call =
        (maximum_memory + memory_per_thread - 1) / memory_per_thread;
    int device_call_count =
        (num_of_chunks + maximum_thread_per_device_call - 1) /
        maximum_thread_per_device_call;
    // size_t chunk_B = chunk_MB * MB;
    std::cout << "Memory Chunk Level: " << chunk_MB << "MB" << endl;
    std::cout << "Memory Level: " << memory_level << endl;
    ...
    auto end_time1 = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> elapsed_time1 = end_time1 - start_time1;
    std::cout << "Memory Allocation Time: " << elapsed_time1.count()
              << " seconds" << endl;
    cudaError_t err = cudaGetLastError();
    if (err != cudaSuccess) {
    ...
    for (int i = 0; i < num_of_thread; i++) {
      // Input
      cudaMallocTracked(&temp_d_input[i], (chunk_B + 5) * sizeof(char));
    ...
    unsigned char **d_encoder_buffer;
    cudaMallocTracked(&d_encoder_buffer,
                      num_of_thread * sizeof(unsigned char *));

    // output file configuration
    std::ofstream dest(destination_file, std::ios::binary);
    if (!dest) {
      std::cout << std::string(destination_file)
                << " does not created/opened.\n";
      exit(1);
    }
    auto start_time = std::chrono::high_resolution_clock::now();
    int expected = 0;
    for (int call_count = 0; call_count < device_call_count; call_count++) {
      // std::cout << "\n\nDevice Call No: " << call_count + 1 << endl;
      int num_of_current_thread = std::min(
          maximum_thread_per_device_call,
          (num_of_chunks - call_count * maximum_thread_per_device_call));
      ...
      cudaMemcpy(d_input_size, input_size.data(),
                 ...
                 cudaMemcpyHostToDevice);
      cudaMemcpy(d_output_size, uncompressed_size.data(),
                 num_of_current_thread * sizeof(size_t),
                 cudaMemcpyHostToDevice);
      for (int i = 0; i < num_of_current_thread; i++) {
        cudaMemcpy(temp_d_input[i], input[i], input_size[i] * sizeof(char),
                   cudaMemcpyHostToDevice);
      }
      ...
      cudaMemcpy(d_output, temp_d_output,
      ...
      for (size_t i = 0; i < num_of_current_thread; i++) {
        ...
        total_input += input_size[i];
        total_output += output_size[i];
        // std::cout << "Thread: " << i + 1 << " " << input_size[i] << " Byte ->
        // " << output_size[i] << " Byte" << endl;
      }
      // std::cout << "From Device Call: " << total_input << " Byte -> " <<
      // total_output << " Byte" << endl;
...
void print_usage(const char *prog_name) {
  ...
  std::cout << "  Compress:   " << file_name
            << " -c [-<memory_level>] <destination_file> [-<chunk_level>] "
               "<source_file>\n";
  std::cout << "  Decompress: " << file_name
  ...
  std::cout << "      or if chunk_level is set higher (higher chunk levels "
               "need more memory).\n";
  std::cout << "    - Use a LOWER value if you have limited VRAM.\n\n";

  std::cout << "  chunk_level: controls compression ratio vs. speed.\n";
  std::cout
      << "    - Use a HIGHER value for a better compression ratio (slower).\n";
  std::cout << "    - Use a LOWER value for faster, smaller (less thorough) "
               "compression.\n\n";
...
int main(int argc, char **args) {
  ...
  std::cout
      << "CUDA version of PAQ9 (warp-cooperative) started successfully.\n\n";
  if (argc < 3) {
    print_usage(args[0]);
    exit(1);
  }
  ...
  std::cout << "Working mode: "
            << (mode == COMPRESS ? "Compressing" : "Decompressing") << endl;
  int ind = 2;
  if (mode == COMPRESS) {
    if (ind < argc && args[ind][0] == '-') {
      ...
      if (memory_level < 1 || memory_level > 11) {
        memory_level = 1;
        std::cout << "Your provided memory level is not supported. It is set "
                     "to default value 1.\n";
      }
      ind++;
    } else if (ind >= argc) {
    ...
    if (ind < argc && args[ind][0] == '-') {
      ...
      if (chunk_level < 1 || chunk_level > 11) {
        chunk_level = 1;
        std::cout << "Your provided level is not supported. It is set to "
                     "default value 1.\n";
      }
      ind++;
    } else if (ind >= argc) {
  ...
  std::cout << "Total GPU memory allocated: " << total_cuda_malloc_allocated
            << " bytes ("
  ...
  std::cout << "Compression/Decompression Speed: "
            << total_uncompressed_size / seconds / 1024 << " KB/seconds \n";

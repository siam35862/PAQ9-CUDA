...
public:
  __device__ Alloc() { total_allocated_size = 0; }
  template <class T> __device__ void alloc(T *&p, size_t allocate_size) {
...
__device__ int Ilog::operator()(U16 x) const { return t[x]; }
...
__device__ static const U8 State_table[256][2] = {
    {1, 2},     {3, 5},     {4, 6},     {7, 10},
    {8, 12},    {9, 13},    {11, 14}, // 0
    {15, 19},   {16, 23},   {17, 24},   {18, 25},
    {20, 27},   {21, 28},   {22, 29}, // 7
    {26, 30},   {31, 33},   {32, 35},   {32, 35},
    {32, 35},   {32, 35},   {34, 37}, // 14
    {34, 37},   {34, 37},   {34, 37},   {34, 37},
    {34, 37},   {36, 39},   {36, 39}, // 21
    {36, 39},   {36, 39},   {38, 40},   {41, 43},
    {42, 45},   {42, 45},   {44, 47}, // 28
    {44, 47},   {46, 49},   {46, 49},   {48, 51},
    {48, 51},   {50, 52},   {53, 43}, // 35
    {54, 57},   {54, 57},   {56, 59},   {56, 59},
    {58, 61},   {58, 61},   {60, 63}, // 42
    {60, 63},   {62, 65},   {62, 65},   {50, 66},
    {67, 55},   {68, 57},   {68, 57}, // 49
    {70, 73},   {70, 73},   {72, 75},   {72, 75},
    {74, 77},   {74, 77},   {76, 79}, // 56
    {76, 79},   {62, 81},   {62, 81},   {64, 82},
    {83, 69},   {84, 71},   {84, 71}, // 63
    {86, 73},   {86, 73},   {44, 59},   {44, 59},
    {58, 61},   {58, 61},   {60, 49}, // 70
    {60, 49},   {76, 89},   {76, 89},   {78, 91},
    {78, 91},   {80, 92},   {93, 69}, // 77
    {94, 87},   {94, 87},   {96, 45},   {96, 45},
    {48, 99},   {48, 99},   {88, 101}, // 84
    {88, 101},  {80, 102},  {103, 69},  {104, 87},
    {104, 87},  {106, 57},  {106, 57}, // 91
    {62, 109},  {62, 109},  {88, 111},  {88, 111},
    {80, 112},  {113, 85},  {114, 87}, // 98
    {114, 87},  {116, 57},  {116, 57},  {62, 119},
    {62, 119},  {88, 121},  {88, 121}, // 105
    {90, 122},  {123, 85},  {124, 97},  {124, 97},
    {126, 57},  {126, 57},  {62, 129}, // 112
    {62, 129},  {98, 131},  {98, 131},  {90, 132},
    {133, 85},  {134, 97},  {134, 97}, // 119
    {136, 57},  {136, 57},  {62, 139},  {62, 139},
    {98, 141},  {98, 141},  {90, 142}, // 126
    {143, 95},  {144, 97},  {144, 97},  {68, 57},
    {68, 57},   {62, 81},   {62, 81}, // 133
    {98, 147},  {98, 147},  {100, 148}, {149, 95},
    {150, 107}, {150, 107}, {108, 151}, // 140
    {108, 151}, {100, 152}, {153, 95},  {154, 107},
    {108, 155}, {100, 156}, {157, 95}, // 147
    {158, 107}, {108, 159}, {100, 160}, {161, 105},
    {162, 107}, {108, 163}, {110, 164}, // 154
    {165, 105}, {166, 117}, {118, 167}, {110, 168},
    {169, 105}, {170, 117}, {118, 171}, // 161
    {110, 172}, {173, 105}, {174, 117}, {118, 175},
    {110, 176}, {177, 105}, {178, 117}, // 168
    {118, 179}, {110, 180}, {181, 115}, {182, 117},
    {118, 183}, {120, 184}, {185, 115}, // 175
    {186, 127}, {128, 187}, {120, 188}, {189, 115},
    {190, 127}, {128, 191}, {120, 192}, // 182
    {193, 115}, {194, 127}, {128, 195}, {120, 196},
    {197, 115}, {198, 127}, {128, 199}, // 189
    {120, 200}, {201, 115}, {202, 127}, {128, 203},
    {120, 204}, {205, 115}, {206, 127}, // 196
    {128, 207}, {120, 208}, {209, 125}, {210, 127},
    {128, 211}, {130, 212}, {213, 125}, // 203
    {214, 137}, {138, 215}, {130, 216}, {217, 125},
    {218, 137}, {138, 219}, {130, 220}, // 210
    {221, 125}, {222, 137}, {138, 223}, {130, 224},
    {225, 125}, {226, 137}, {138, 227}, // 217
    {130, 228}, {229, 125}, {230, 137}, {138, 231},
    {130, 232}, {233, 125}, {234, 137}, // 224
    {138, 235}, {130, 236}, {237, 125}, {238, 137},
    {138, 239}, {130, 240}, {241, 125}, // 231
    {242, 137}, {138, 243}, {130, 244}, {245, 135},
    {246, 137}, {138, 247}, {140, 248}, // 238
    {249, 135}, {250, 69},  {80, 251},  {140, 252},
    {249, 135}, {250, 69},  {80, 251},           // 245
...
__device__ Mix::Mix(int n)
    : N(n), x1(0), x2(0), context(0), last_prediction(0) {
...
template <int B> __device__ HashTable<B>::~HashTable() {
  ...
  // printf("Thread No: %d :-HashTable<%d> %1.4f%% full, %1.4f%% utilized of %d
  // KiB\n", get_tid(),
...
__device__ size_t MEM =
    1 << (22 + 1); // Global memory limit, 1 << 22+(memory option)
...
__device__ LZP::LZP()
    : N(MEM / 8), H(MEM / 32), match(-1), len(0), pos(0), hash(0), hash1(0),
      hash2(0), statemap1(0x200), apm1(0x10000), apm2(0x40000), apm3(0x100000),
...
__device__ LZP::~LZP() {
  ...
  // get_tid(),
  //        literals, matches,
  //        literals + matches > 0 ? 100.0 * matches / (literals + matches) :
  //        0.0);
  delete[] table;
  delete[] buf;
  table = 0;
...
__device__ Predictor::Predictor()
    : c0(0), nibble(1), bcount(0), hashtable(MEM / 2), apm1(0x10000),
      apm2(0x10000), apm3(0x10000) {
...
__device__ int Predictor::predict_next_bit() {
  ...
  if (c0 == 0)
    ...
    int r = (pc + 256) >> (8 - bcount) ==
            c0; // c0 consistent with mispredicted byte?
    U32 c4 =
    ...
    if ((bcount & 3) == 0) { // nibble boundary?  Update context pointers
      ...
      cp[10] =
          hashtable[lzp[tid]->word1 * 7 + lzp[tid]->word0 * 11 + c0 + pc * 37];
    }
...
__device__ Encoder::Encoder(int m, char *temp, size_t tsz, size_t itr)
    : mode(m), inout(temp), total_size(tsz), iterator_size(itr), x1(0),
      x2(0xffffffff), x(0), usize(0), csize(0), usum(0), csum(0) {
  int tid = get_tid();
  buf = 0;
...
__global__ void paq9_cuda(size_t *input_size, char **input, size_t *output_size,
                          char **output, int num_of_chunks, int mode,
                          int memory_level) {
  int tid = get_tid();
...
size_t getMaximumHeapLimit() {
  ...
  if (err != cudaSuccess) {
    ...
    if (err1 != cudaSuccess)
      std::cerr << "Heap Launch error: " << cudaGetErrorString(err1) << '\n';
    exit(1);
  }
  return bestLimit;
}
...
void compress(char *destination_file, char *source_file) {
  ...
  // std::cout << memory_chunk_level << " " << memory_level << " " <<
  // memory_per_thread << " " << maximum_thread_per_device_call << " " <<
  // chunk_B << endl;
  ...
  for (int call_count = 0; call_count < device_call_count; call_count++) {
    ...
    for (size_t i = 0; i < num_of_current_thread; i++) {
      size_t current_B = std::min(
          chunk_B,
          total_B -
              ((call_count * maximum_thread_per_device_call) + i) * chunk_B);
    ...
    cudaMallocTracked(&d_input_size, num_of_current_thread * sizeof(size_t));
    ...
    char **temp_d_input = new char *[num_of_current_thread];

    char **temp_d_output = new char *[num_of_current_thread];
    ...
    for (int i = 0; i < num_of_current_thread; i++) {
      // Input
      cudaMallocTracked(&temp_d_input[i], input_size[i] * sizeof(char));

      // Output
      //
      // Currently output size == input size
      // because your kernel only copies data.
      cudaMallocTracked(&temp_d_output[i], (input_size[i] + 2) * sizeof(char));
    ...
    paq9_cuda<<<blocks, threads>>>(d_input_size, d_input, d_output_size,
                                   d_output, num_of_current_thread, COMPRESS,
                                   memory_level);
    ...
    size_t *output_size =
        (size_t *)malloc(num_of_current_thread * sizeof(size_t));
  ...
  if (mode == 's') {
    ...
    for (int call_count = 0; call_count < device_call_count; call_count++) {
      ...
      for (int i = 0; i < num_of_current_thread; i++) {
        ...
        // Currently output size == input size
        // because your kernel only copies data.
        cudaMallocTracked(&temp_d_output[i],
      ...
      paq9_cuda<<<blocks, threads>>>(d_input_size, d_input, d_output_size,
                                     d_output, num_of_current_thread,
                                     DECOMPRESS, memory_level);
      ...
      for (size_t i = 0; i < num_of_current_thread; i++) {
        ...
        total_input += input_size[i];
        total_output += output_size[i];
        // std::cout << input_size[i] << " Byte -> " << output_size[i] << "
        // Byte" << endl;
      }
...
int main(int argc, char **args) {
  ...
  std::cout << "Total GPU memory allocated: " << maximum_device_call_memory
            << " bytes ("
